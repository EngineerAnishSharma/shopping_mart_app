        ...
        body: Obx(()=>
            SingleChildScrollView(
              ...
              children: [
                ...
                },color1: redColor,textColor: whiteColor,title: "Change"),
                const Divider(),
                20.heightBox,
                customTextField(name, nameHint,controller.nameController,false),
                10.heightBox,
                customTextField(oldpass, passwordHint,controller.oldpassController, true),
                10.heightBox,
                customTextField(newpass, passwordHint,controller.newpassController, true),
                20.heightBox,
                //loading
                ...
                :SizedBox(
                  width: context.width-60,
                    ...
                    },color1: redColor,textColor: whiteColor,title: "Save")
                ),
              ],
          ).box.white.shadowSm.rounded.padding(const EdgeInsets.all(16)).margin(const EdgeInsets.only(top: 50,left: 16,right: 16)).make(),
            ),
        ),
      )
    );
