...
class _SignupScreenState extends State<SignupScreen> {
  ...
  bool? isCheck=false;
  var controller=Get.put(AuthController()); // get everything from AuthController
            ...
            children: [
              ...
              Obx(()=>
                  ...
                  children: [
                    ...
                    customTextField(retypePass,passwordHint,retypePasswordController,true),
                    Align(
                        ...
                        onPress: () async{
                          if(isCheck!=false){
                            try{
                              ...
                              await controller.signupMethod(email: emailController.text,password: passwordController.text,context: context)
                              .then((value){
